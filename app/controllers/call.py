...
from app.schemas.call_crm_driver_us import CallCrmCreate,CallCrmUpdate

class CallController(CRUDBase[CallCrmDriverUs, CallCrmCreate, CallCrmUpdate]):
...
call_controller = CallController(CallCrmDriverUs)